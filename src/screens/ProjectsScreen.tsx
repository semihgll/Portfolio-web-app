...
const LOCAL_IMAGES: Record<string, any[]> = {
    ...
    'Pandoras Redemption': [require('../../assets/pr_anamenu.png'), require('../../assets/pr_pcg.png'), require('../../assets/pr_enemy_1_ice.png'), require('../../assets/pr_enemy_2.png'), require('../../assets/pr_stone.png'), require('../../assets/pr_char.png'), require('../../assets/pr_column.png')]
};
